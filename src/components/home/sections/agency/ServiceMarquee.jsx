...
function ServiceCard({ service }) {
  return (
    <div
      className="group relative flex h-[443px] shrink-0 flex-col gap-4 overflow-hidden rounded-2xl border-2 border-[#8e38f8] p-8 shadow-[inset_3px_1px_31px_-6px_#bd27f6]"
